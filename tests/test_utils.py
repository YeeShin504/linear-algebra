...
from ma1522.utils import _is_zero, _powerset
...
class TestUtils:
    ...
    def test_latex_wrapping(self):
        from ma1522.utils import _unwrap_latex, _wrap_latex
    ...
    def test_display_ipython_and_fallback(self):
        ...
        # IPython SUCCESS
        with (
            patch("ma1522.utils._is_IPython", return_value=True),
        ...
        with (
            patch("ma1522.utils._is_IPython", return_value=False),
