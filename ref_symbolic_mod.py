...
class Matrix(sym.MutableDenseMatrix):
    ...
    def intersect_subspace(self, other: "Matrix", verbosity: int = 2) -> "Matrix":
        ...
        Example:
            >>> mat1 = sym.Matrix([[1, 0], [0, 1]])
            >>> mat2 = sym.Matrix([[1, 1], [0, 0]])
    ...
    def is_same_subspace(self, other: "Matrix", verbosity: int = 2) -> bool:
        ...
        Raises:
            AssertionError: If the number of rows in the current matrix and the target matrix are different.
        ...
        ), "Number of rows must be the same in both matrices."
